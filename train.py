...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/mnt/Stuff/TTS/speech_synthesis_in_bangla-master/logs/gradtts_sdp/grad_9.pt",
    ...
    model.load_state_dict(torch.load("/mnt/Stuff/TTS/speech_synthesis_in_bangla-master/logs/multistream_stft_diffusion/2/grad_2.pt",
                                      map_location=lambda loc, storage: loc))
