...
class Sentence2GraphParser:
    ...
    def __init__(self, language='zh', use_gpu=False):
        pass
...
#             ret = self._parse_zh_or_bn(words, ph_words)
...
#     def _parse_zh_or_bn(self, words, ph_words, enable_backward_edge=True, enable_recur_edge=True,
...
#         else:
#             """TODO: Replace with Bangla Dependency parser"""
#             parser_out = None
