...
import random
from model.stft_vocoder import Multiband_iSTFT_Generator, iSTFT_Generator, Multistream_iSTFT_Generator
...
class StftDiffusion(BaseModule):
    def __init__(self, n_feats, dim,
                 initial_channel, resblock, resblock_kernel_sizes,
        ...
        super(StftDiffusion, self).__init__()
        self.n_feats = n_feats
        self.dim = dim
        self.n_spks = n_spks
        self.spk_emb_dim = spk_emb_dim
    ...
    def reverse_diffusion(self, z, mask, mu, n_timesteps, stoc=False, spk=None):
        ...
        y_g_hat, y_mb_hat = self.stft_generator(xt)

        return xt, y_g_hat, y_mb_hat
