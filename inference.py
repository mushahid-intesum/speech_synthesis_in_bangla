...
if __name__ == '__main__':
  ...
  """ GradTTSSDP """
    ...
    generator.load_state_dict(torch.load('D:\ooga\Thesis\Bangla_TTS\scratch_implementations\Grad-TTS\logs\new_exp_sdp\grad_46.pt', map_location=lambda loc, storage: loc))
